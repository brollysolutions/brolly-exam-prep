...
export default function HomeRoute() {
  ...
  return (
    <HomeView
      ...
      // Ungated, and `navigate` rather than `push`: a topic row only moves you to the shelf,
      // which is readable by anyone — the paper you pick there is what asks for an account.
