 ...
 * and the unit keeps its own script, because Archivo has no Telugu or Nastaliq glyphs. The row
 * follows the reading direction, so Urdu reads right-to-left with the number leading.
 *
