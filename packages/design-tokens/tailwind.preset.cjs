...
module.exports = {
  theme: {
    ...
    extend: {
      ...
      height: { touch: px(t.size.touch), touchLg: px(t.size.touchLg), key: px(t.size.key), field: px(t.size.field), rail: px(t.size.rail), progress: px(t.size.progress) },
      minHeight: { touch: px(t.size.touch), touchLg: px(t.size.touchLg) },
      minWidth: { touch: px(t.size.touch) },
      width: { touch: px(t.size.touch), touchLg: px(t.size.touchLg) },
      transitionDuration: { fast: `${t.motion.fast}ms`, base: `${t.motion.base}ms`, slow: `${t.motion.slow}ms` },
    },
  },
};
