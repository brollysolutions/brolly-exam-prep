    ...
    blocks: [
      ...
      },
      {
        ...
        text: {
          ...
          te: 'Percentage change = (New − Old) ÷ Old × 100\nSuccessive change = a + b + (a × b) ÷ 100',
          ur: 'Percentage change = (New − Old) ÷ Old × 100\nSuccessive change = a + b + (a × b) ÷ 100',
        },
      },
      {
        kind: 'example',
    ...
    blocks: [
      ...
      },
      {
        ...
        text: {
          ...
          te: 'Speed = Distance ÷ Time\nkm/h → m/s: × 5/18      m/s → km/h: × 18/5',
          ur: 'Speed = Distance ÷ Time\nkm/h → m/s: × 5/18      m/s → km/h: × 18/5',
        },
      },
      {
        kind: 'example',
    ...
    blocks: [
      ...
      },
      {
        ...
        text: {
          ...
          te: 'కొన్న ధర (CP) అంటే అమ్మేవాడు చెల్లించినది, అమ్మిన ధర (SP) అంటే కొనేవాడు చెల్లించినది. ప్రశ్నలో వేరేగా చెప్పకపోతే లాభ, నష్ట శాతాలను ఎప్పుడూ కొన్న ధరపైనే లెక్కిస్తారు.',
          ur: 'لاگت (CP) وہ ہے جو بیچنے والے نے ادا کی، اور فروخت قیمت (SP) وہ جو خریدار نے ادا کی۔ جب تک سوال میں کچھ اور نہ کہا جائے، نفع اور نقصان کا فیصد ہمیشہ لاگت پر ناپا جاتا ہے۔',
        },
      },
      {
        kind: 'para',
        text: {
          ...
          te: 'డిస్కౌంట్ ఒక్కటే మినహాయింపు. డిస్కౌంట్‌ను ఎప్పుడూ ముద్రిత ధర (MP)పైనే లెక్కిస్తారు, కొన్న ధరపై కాదు. అందుకే దుకాణం 20% తగ్గించినా లాభం పొందగలుగుతుంది.',
          ur: 'رعایت اس کا واحد استثنا ہے۔ رعایت ہمیشہ لکھی ہوئی قیمت (MP) پر ناپی جاتی ہے، لاگت پر نہیں — اسی لیے دکاندار 20% رعایت دے کر بھی نفع کما لیتا ہے۔',
        },
      },
      {
        kind: 'para',
        ...
        items: [
          {
            ...
            te: 'SP అనేది CP కంటే ఎక్కువైతే లాభం; తక్కువైతే నష్టం. లెక్క వేసే ముందు పోల్చండి.',
            ur: 'SP، CP سے زیادہ ہو تو نفع؛ کم ہو تو نقصان۔ حساب سے پہلے موازنہ کریں۔',
          },
          {
            en: 'A 25% profit means CP : SP = 4 : 5. Ratios are faster than decimals here.',
            te: '25% లాభం అంటే CP : SP = 4 : 5. ఇక్కడ దశాంశాల కంటే నిష్పత్తులే వేగవంతం.',
            ur: '25% نفع کا مطلب CP : SP = 4 : 5 ہے۔ یہاں اعشاریہ سے تناسب زیادہ تیز ہے۔',
          },
          {
      ...
      },
      {
        ...
        text: {
          ...
          te: 'Profit % = (SP − CP) ÷ CP × 100\nSP = CP × (100 + Profit %) ÷ 100',
          ur: 'Profit % = (SP − CP) ÷ CP × 100\nSP = CP × (100 + Profit %) ÷ 100',
        },
      },
      {
        kind: 'example',
        text: {
          ...
          te: 'ఒక వస్తువును 15% లాభంతో అమ్మితే ₹460 వచ్చింది. దాని కొన్న ధర ఎంత? అమ్మిన ధర కొన్న ధరలో 115%, కాబట్టి CP = 460 × 100 ÷ 115 = ₹400. సరిచూసుకోండి: 400లో 15% అంటే 60, మరి 400 + 60 = 460.',
          ur: 'ایک چیز 15% نفع پر ₹460 میں فروخت ہوئی۔ اس کی لاگت کیا تھی؟ فروخت قیمت لاگت کا 115% ہے، لہٰذا CP = 460 × 100 ÷ 115 = ₹400۔ جانچ لیں: 400 کا 15% یعنی 60، اور 400 + 60 = 460۔',
        },
      },
      {
        kind: 'tip',
    ...
    blocks: [
      ...
      },
      {
        ...
        text: {
          ...
          te: 'Notation:  + male    − female    = married couple    | child of',
          ur: 'Notation:  + male    − female    = married couple    | child of',
        },
      },
      {
        kind: 'example',
    ...
    blocks: [
      ...
      },
      {
        ...
        text: {
          ...
          te: 'Facing centre:   their left  = your right\nFacing outward:  their left  = your left',
          ur: 'Facing centre:   their left  = your right\nFacing outward:  their left  = your left',
        },
      },
      {
        kind: 'example',
