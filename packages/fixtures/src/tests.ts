...
export const TESTS: TestMeta[] = [
  ...
  { id: 'prev-2022', kind: 'previous', title: { en: 'PWT 2022 — SCT PC', te: 'PWT 2022 — SCT PC', ur: 'پی ڈبلیو ٹی 2022 — SCT PC' }, pattern: PWT_CONSTABLE, free: true },
  { id: 'prev-2018', kind: 'previous', title: { en: 'PWT 2018 — SCT PC', te: 'PWT 2018 — SCT PC', ur: 'پی ڈبلیو ٹی 2018 — SCT PC' }, pattern: PWT_CONSTABLE, free: true },
];
