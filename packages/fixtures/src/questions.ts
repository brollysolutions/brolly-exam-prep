...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: { en: ['27', '64', '100', '125'], te: ['27', '64', '100', '125'], ur: ['27', '64', '100', '125'] },
    correct: 2,
    explanation: {
  ...
  },
  {
    ...
    options: { en: ['₹380', '₹400', '₹410', '₹425'], te: ['₹380', '₹400', '₹410', '₹425'], ur: ['₹380', '₹400', '₹410', '₹425'] },
    correct: 1,
    explanation: {
      en: 'Selling price = 115% of cost. Cost = 460 ÷ 1.15 = ₹400.',
      te: 'అమ్మకపు ధర = కొన్న ధరలో 115%. కొన్న ధర = 460 ÷ 1.15 = ₹400.',
      ur: 'فروخت قیمت = لاگت کا 115%۔ لاگت = 460 ÷ 1.15 = ₹400۔',
    },
    avgSeconds: 44,
  },
  {
    ...
    options: { en: ['HVBSE', 'HVBRE', 'HUBSE', 'GVBSE'], te: ['HVBSE', 'HVBRE', 'HUBSE', 'GVBSE'], ur: ['HVBSE', 'HVBRE', 'HUBSE', 'GVBSE'] },
    correct: 0,
    explanation: {
  ...
  },
  {
    ...
    options: { en: ['Krishna', 'Godavari', 'Tungabhadra', 'Manjeera'], te: ['కృష్ణా', 'గోదావరి', 'తుంగభద్ర', 'మంజీరా'], ur: ['کرشنا', 'گوداوری', 'تنگ بھدرا', 'منجیرا'] },
    correct: 1,
    explanation: {
  ...
  },
  {
    ...
    text: {
      ...
      ur: 'تلنگانہ بھارت کی 29ویں ریاست کے طور پر کس تاریخ کو قائم ہوا؟',
    },
    options: { en: ['1 June 2014', '2 June 2014', '15 August 2014', '26 January 2015'], te: ['1 జూన్ 2014', '2 జూన్ 2014', '15 ఆగస్టు 2014', '26 జనవరి 2015'], ur: ['یکم جون 2014', '2 جون 2014', '15 اگست 2014', '26 جنوری 2015'] },
    correct: 1,
    explanation: {
      ...
      ur: 'آندھرا پردیش ری آرگنائزیشن ایکٹ 2014 کے تحت تلنگانہ 2 جون 2014 کو وجود میں آیا۔',
    },
    avgSeconds: 22,
  },
];
