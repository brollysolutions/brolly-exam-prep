---
name: design-audit
description: Review UI visual hierarchy, spacing, typography, consistency, responsiveness, and accessibility against the project design system. Use for requested design audits and UI reviews.
---
